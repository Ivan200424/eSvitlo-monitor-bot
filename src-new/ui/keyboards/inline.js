import { REGIONS, QUEUES } from '../../config/constants.js';

// Головне меню після /start для існуючих користувачів
export function getMainMenu(botStatus = 'active', channelPaused = false) {
  const buttons = [
    [
...
// Вибір черги
export function getQueueKeyboard() {
  const buttons = [];
  const row = [];
...
// Меню налаштувань
export function getSettingsKeyboard(isAdmin = false) {
  const buttons = [
    [
...
export function getAlertsSettingsKeyboard() {
  return {
    reply_markup: {
      inline_keyboard: [
        [
...
export function getAdminIntervalsKeyboard(currentScheduleInterval, currentIpInterval) {
  return {
    reply_markup: {
      inline_keyboard: [
...
export function getScheduleIntervalKeyboard() {
  return {
    reply_markup: {
      inline_keyboard: [
        [
...
export function getIpIntervalKeyboard() {
  return {
    reply_markup: {
      inline_keyboard: [
        [
...
export function getDeactivateConfirmKeyboard() {
  return {
    reply_markup: {
      inline_keyboard: [
...
export function getDeleteDataConfirmKeyboard() {
  return {
    reply_markup: {
      inline_keyboard: [
        [
...
export function getDeleteDataFinalKeyboard() {
  return {
    reply_markup: {
      inline_keyboard: [
        [
...
// IP моніторинг меню
export function getIpMonitoringKeyboard() {
  return {
    reply_markup: {
      inline_keyboard: [
...
export function getIpCancelKeyboard() {
  return {
    reply_markup: {
      inline_keyboard: [
...
// Канал меню
export function getChannelMenuKeyboard(channelId = null, isPublic = false, channelStatus = 'active') {
  const buttons = [];
...
export function getRestorationKeyboard() {
  return {
    reply_markup: {
      inline_keyboard: [
...
export function getFormatSettingsKeyboard(user) {
...
export function getTestPublicationKeyboard() {
  return {
    reply_markup: {
      inline_keyboard: [
...
// Меню режиму паузи
export function getPauseMenuKeyboard(isPaused) {
...
export function getPauseMessageKeyboard(showSupportButton) {
...
export function getPauseTypeKeyboard(currentType = 'update') {
  const types = [
...
export function getNotifyTargetKeyboard(currentTarget = 'both') {
  const options = [
...
export function getWizardNotifyTargetKeyboard() {
  return {
    reply_markup: {
      inline_keyboard: [
...
export function getGrowthKeyboard() {
  return {
    reply_markup: {
      inline_keyboard: [
...
export function getGrowthStageKeyboard(currentStage) {
  return {
    reply_markup: {
      inline_keyboard: [
...
export function getGrowthRegistrationKeyboard(enabled) {
